                  ...
                  else if(src_cell_indexi>=16&&src_cell_indexi!=-1)
                  {
                      ...
                      if(piece_id>=8 &&piece_id<=11)
                      {
                        ...
                        int targ_index=-1;
                          ...
                          */
                          System.out.println("GREEN INDEX " + targ_index);
                          if(targ_index!=-1&&targ_index<=56)
                          {
                                   if(targ_index==56)
                              {
                                  players[2].no_of_pieces_home++;
                              }
                              if(players[2].no_of_pieces_home==4)
                              {
                                 for(int f=0;f<3;f++)
                                 {
                                     if(winner[f]=="")
                                     {
                                         winner[f]="Winner " + (f+1) + ": Green";
                                         break;
                                     }
                                 }
                              }
                          
                          int targ_x = b.GREENX[targ_index];
                          int targ_y = b.GREENY[targ_index];
                          int minx = targ_x-factor,maxx=targ_x+factor;
                          int miny = targ_y-factor,maxy=targ_y+factor;
                            ...
                            {
                                int enemy_id =(int) b.cell_pieces[targ_cell_indexi].get(0);
                                if(enemy_id>=8 && enemy_id<=11) // not enemy
                                {
                                    b.cell_pieces[src_cell_indexi].remove(k);  //remove from piece from the sourc cell
                                    b.cell_pieces[targ_cell_indexi].add(piece_id);//add piece to the target cell
                                    w[piece_id]=20;h[piece_id]=35;
                                    w[enemy_id]=20;h[enemy_id]=35;
                                    arr_x[piece_id]=b.GREENX[targ_index]-10;
                                    arr_y[piece_id]=b.GREENY[targ_index]+10; 
                                    arr_x[enemy_id]=b.GREENX[targ_index]+15;
                                    arr_y[enemy_id]=b.GREENY[targ_index]+10; 
                                    ...
                                    for(int ii=0;ii<4;ii++)
                                    {
                                        if(players[2].pieces[ii].id ==piece_id)
                                        {
                                            ...
                                            players[2].pieces[ii].color_path_id = targ_index;
                                        }
                                    }
                                     turnn=true;
                                     superNumber = -1;
                                ...
                                else //enemy
                                {
                                    ...
                                    b.cell_pieces[src_cell_indexi].remove(k);  //remove  piece from the sourc cell
                                    b.cell_pieces[targ_cell_indexi].add(piece_id);//add piece to the target cell
                                    arr_x[piece_id]=b.GREENX[targ_index];
                                    arr_y[piece_id]=b.GREENY[targ_index]; 
                             ...
                             else if(b.cell_pieces[targ_cell_indexi].size()==3)
                            {
                                ...
                                w[friend1]=20;h[friend1]=25;
                                w[friend2]=20;h[friend2]=25;
                                arr_x[friend]=b.GREENX[targ_index]+20;
                                arr_y[friend]=b.GREENY[targ_index]+10;
                                arr_x[friend1]=b.GREENX[targ_index]-15;
                                arr_y[friend1]=b.GREENY[targ_index]+30;
                                arr_x[piece_id]=b.GREENX[targ_index]-15;
                                arr_y[piece_id]=b.GREENY[targ_index]+8;
                                arr_x[friend2]=b.GREENX[targ_index]+20;
                                arr_y[friend2]=b.GREENY[targ_index]+8;
                                for(int ii=0;ii<4;ii++)
                                    {
                                        if(players[2].pieces[ii].id ==piece_id)
                                        {
                                ...
                                int friend =(int) b.cell_pieces[targ_cell_indexi].get(0);
                                 b.cell_pieces[src_cell_indexi].remove(k);  //remove from piece from the sourc cell
                                   ...
                                   w[piece_id]=20;h[piece_id]=35;
                                    ...
                                    arr_x[piece_id]=b.GREENX[targ_index]-10;
                                    arr_y[piece_id]=b.GREENY[targ_index]+10; 
                                    arr_x[friend]=b.GREENX[targ_index]+15;
                                    arr_y[friend]=b.GREENY[targ_index]+10; 
              ...
              else if(turn=='B'||turn=='b')
              {
                  if(src_cell_indexi<16 && src_cell_indexi!=-1&&step==6)  // still out of the game
                  {
                      ...
                      for(k=0;k<b.cell_pieces[src_cell_indexi].size();k++)
                      {
                          ...
                          if(piece_id>=12 && piece_id<=15)    //found true
                          {
                             break; 
                          }
                      }
                        if(piece_id>=12 && piece_id<=15)    //found true
                          {
                            ...
                            int targ_x = b.BLUEX[0];   // get positions of the target cell;
                            int targ_y = b.BLUEY[0];
                           ...
                           // System.out.println(z);
                            if(true) //check the cell number
                            {
                                ...
                                b.cell_pieces[src_cell_indexi].remove(k);  //remove from piece from the sourc cell
                                b.cell_pieces[targ_cell_indexi].add(piece_id);//add piece to the target cell
                                arr_x[piece_id]=b.BLUEX[0];
                                arr_y[piece_id]=b.BLUEY[0];
                                // set target cell 
                                for(int ii=0;ii<4;ii++)
                                {
                                    if(players[3].pieces[ii].id ==piece_id)
                                    {
                                        players[3].pieces[ii].color_path_id = 0;
                                    }
                                }
                                 turnn=true;
                                 superNumber = -1;
                        ...
                        int targ_index=-1;
                          ...
                          for(int ii=0;ii<4;ii++)  // get piece current location on the colored path
                          {
                              ...
                              if(players[3].pieces[ii].id==piece_id)
                              {
                                  ...
                                  curr_index = players[3].pieces[ii].color_path_id;
                                  targ_index=curr_index +step;
                                //  System.out.println("curr_index on the full path" + curr_index );
                          ...
                          if(targ_index!=-1&&targ_index<=56)
                          {
                              ...
                              if(targ_index==56)
                              {
                                  players[3].no_of_pieces_home++;
                              }
                              if(players[3].no_of_pieces_home==4)
                              {
                                  for(int f=0;f<3;f++)
                                 {
                                     if(winner[f]=="")
                                     {
                                         winner[f]="Winner " + (f+1) + ": Blue";
                                         break;
                                     }
                                 }
                              }
                          int targ_x = b.BLUEX[targ_index];
                          int targ_y = b.BLUEY[targ_index];
                          int minx = targ_x-factor,maxx=targ_x+factor;
                          int miny = targ_y-factor,maxy=targ_y+factor;
                            ...
                            {
                                int enemy_id =(int) b.cell_pieces[targ_cell_indexi].get(0);
                                if(enemy_id>=12 && enemy_id<=15) // not enemy
                                {
                                     turnn=true;
                                     superNumber = -1;
                                    b.cell_pieces[src_cell_indexi].remove(k);  //remove from piece from the sourc cell
                                    b.cell_pieces[targ_cell_indexi].add(piece_id);//add piece to the target cell
                                     w[piece_id]=20;h[piece_id]=35;
                                    w[enemy_id]=20;h[enemy_id]=35;
                                    arr_x[piece_id]=b.BLUEX[targ_index]-10;
                                    arr_y[piece_id]=b.BLUEY[targ_index]+10; 
                                    arr_x[enemy_id]=b.BLUEX[targ_index]+15;
                                    arr_y[enemy_id]=b.BLUEY[targ_index]+10; 
                                    ...
                                    for(int ii=0;ii<4;ii++)
                                    {
                                        if(players[3].pieces[ii].id ==piece_id)
                                        {
                                            ...
                                            players[3].pieces[ii].color_path_id = targ_index;
                                        }
                                    }
                                }
                                else //enemy
                                {
                                    ...
                                    b.cell_pieces[src_cell_indexi].remove(k);  //remove  piece from the sourc cell
                                    b.cell_pieces[targ_cell_indexi].add(piece_id);//add piece to the target cell
                                    arr_x[piece_id]=b.BLUEX[targ_index];
                                    arr_y[piece_id]=b.BLUEY[targ_index]; 
                            ...
                            else if(b.cell_pieces[targ_cell_indexi].size()==3)
                            {
                                ...
                                w[friend1]=20;h[friend1]=25;
                                w[friend2]=20;h[friend2]=25;
                                arr_x[friend]=b.BLUEX[targ_index]+20;
                                arr_y[friend]=b.BLUEY[targ_index]+10;
                                arr_x[friend1]=b.BLUEX[targ_index]-15;
                                arr_y[friend1]=b.BLUEY[targ_index]+30;
                                arr_x[piece_id]=b.BLUEX[targ_index]-15;
                                arr_y[piece_id]=b.BLUEY[targ_index]+8;
                                arr_x[friend2]=b.BLUEX[targ_index]+20;
                                arr_y[friend2]=b.BLUEY[targ_index]+8;
                                for(int ii=0;ii<4;ii++)
                                    {
                                        if(players[3].pieces[ii].id ==piece_id)
                                        {
                                ...
                                int friend =(int) b.cell_pieces[targ_cell_indexi].get(0);
                                 b.cell_pieces[src_cell_indexi].remove(k);  //remove from piece from the sourc cell
                                   ...
                                   w[piece_id]=20;h[piece_id]=35;
                                    ...
                                    arr_x[piece_id]=b.BLUEX[targ_index]-10;
                                    arr_y[piece_id]=b.BLUEY[targ_index]+10; 
                                    arr_x[friend]=b.BLUEX[targ_index]+15;
                                    arr_y[friend]=b.BLUEY[targ_index]+10; 
 ...
 public char turncolor(char color)
  {
      ...
      if(color=='Y')
      {
       ...
       else if(color=='R' && number_of_players>2)
      {
          nextcolor='G';
          mouse="green";
      }
     ...
     else if(color=='G' &&number_of_players>3)
      {
          nextcolor='B';
          mouse="blue";
      }
